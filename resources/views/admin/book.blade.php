...
<body>
     <h1 class="text-center mt-12">Add New Book</h1>
    <form action="{{url('/admin/add-book')}}" method="POST" class="container-fluid col-6 mt-4">
        @csrf
        <div class="form-group">
            <label for="exampleInputPassword1">Book Name</label>
            <input type="text" class="form-control"  placeholder="Name"  name="book_name"> 
        </div>
        <div class="form-group">
                <label for="exampleInputPassword1">Book Year</label>
                <input type="text" class="form-control"  placeholder="Publish Year"  name="book_year"> 
        </div>
        <div class="form-group">
